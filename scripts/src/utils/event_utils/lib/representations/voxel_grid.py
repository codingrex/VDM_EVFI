...
import cv2 as cv
import torch
from ..util.event_util import events_bounds_mask, binary_search_torch_tensor
from .image import events_to_image, events_to_image_torch
import os


SAVE_ROOT= '/home/jxchen/Documents/Github/04_EVSVD/Ev_scripts/VIS/test'
...
def plot_voxel_grid(voxelgrid, cmap='gray'):
    ...
    # save_path = os.path.join(SAVE_ROOT, 'voxel_grid.png')

    # cv.imwrite(save_path, sidebyside)
